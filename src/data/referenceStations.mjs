...
const referenceStations = [
  ...
  { name: 'Umeå Flygplats', lat: 63.7931, lon: 20.28, country: 'SE' },
  { name: 'Luleå-Kallax Flygplats', lat: 65.543, lon: 22.124, country: 'SE' },
  { name: 'Kiruna', lat: 67.8565, lon: 20.2937, country: 'SE' },

  // Norway
  { name: 'Oslo Blindern', lat: 59.9423, lon: 10.72, country: 'NO' },
  { name: 'Bergen Florida', lat: 60.383, lon: 5.3327, country: 'NO' },
