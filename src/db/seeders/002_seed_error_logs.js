  ...
  const errorLogs = [
    {
      ...
      created_at: new Date('2001-01-15T10:45:00Z'),
    },
    {
    ...
    },
    {
      ...
      route: '/v1/auth/login',
      environment: 'production',
      created_at: new Date('2001-01-15T15:10:00Z'),
    },
    {
      message: 'SMTP connection timeout',
      stack_trace:
        'Error: SMTP connection timeout\n    at SMTPConnection._formatError (/app/node_modules/nodemailer/lib/smtp-connection/index.js:791:19)\n    at SMTPConnection._onTimeout (/app/node_modules/nodemailer/lib/smtp-connection/index.js:588:26)',
      route: null,
      environment: 'production',
    ...
    },
    {
      ...
      stack_trace:
        'SequelizeUniqueConstraintError: Validation error\n    at Query.formatError (/app/node_modules/sequelize/lib/dialects/postgres/query.js:418:16)\n    at Query.run (/app/node_modules/sequelize/lib/dialects/postgres/query.js:122:18)',
      route: '/v1/auth/register',
      environment: 'production',
      created_at: new Date('2001-01-15T16:45:00Z'),
    },
  ];
