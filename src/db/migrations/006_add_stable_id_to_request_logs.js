...
export async function up({ context: queryInterface }) {
  ...
  await queryInterface.sequelize.query('UPDATE request_logs SET stable_id = gen_random_uuid() WHERE stable_id IS NULL');
  ...
  await queryInterface.sequelize.query('ALTER TABLE request_logs ALTER COLUMN stable_id SET NOT NULL');
}
