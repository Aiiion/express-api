...
export const MET_ALERTS_API_URL = "https://api.met.no/weatherapi/metalerts/2.0";
...
export const exampleLat = "40.7128";
export const exampleLon = "-74.0060";
export const exampleLatLon = {
    lat: exampleLat,
    lon: exampleLon,
};
