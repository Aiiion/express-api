import { MET_ALERTS_API_URL, MET_API_URL } from '../../utils/constants.mjs';
...
const metService = {
  forecastWeather: (lat, lon) =>
    withCache(`met:forecast:${lat}:${lon}`, MET_CACHE_TTL, () => metFetch(MET_API_URL, '/compact', { lat, lon })),

  weatherWarnings: (lat, lon) =>
    withCache(`met:warnings:${lat}:${lon}`, MET_CACHE_TTL, () =>
